...
const searchword = (keyword) => {
    ...
    const searchindex = categories.findIndex(element => element.name.toLowerCase().includes(keyword.toLowerCase()) || keyword.toLowerCase().includes(element.name.toLowerCase()));
    ...
    if (searchindex !== -1) {
        ...
        for(var i = 0;i< categories.length;i++){
            if(similar_text(categories[i].name.toLowerCase(), keyword.toLowerCase()) >=3){
